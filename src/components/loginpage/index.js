...
const url = "https://api.codechef.com/oauth/authorize?response_type=code&client_id="+client_id+"&state=xyz&redirect_uri=https://sunburn21.github.io/contestchef/auth";
const loginone = ()=>{
