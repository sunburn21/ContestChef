...
const url = "https://api.codechef.com/oauth/authorize?response_type=code&client_id="+client_id+"&state=xyz&redirect_uri=https://angry-chandrasekhar-fdd376.netlify.com/auth";
const loginone = ()=>{
